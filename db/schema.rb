...
ActiveRecord::Schema.define(version: 2018_09_05_171051) do
  ...
  create_table "user_tutorials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
  ...
  add_foreign_key "user_tutorials", "tutorials"
